# S3 · Solution (0:09–0:14, 5s)

> **목표 메시지:** True Mirror로 남들이 보는 진짜 나를 동시에
> 공통: 9:16 (1080×1920) · 30fps · 인디고 `#5856D6` · 블루그레이 `#546E7A`
> 출력: `S03_solution_app-demo.mp4`
...
## 검수
- PiP 스왑·리사이즈가 **실제 기능**처럼 자연스러운지 확인

## 오버레이 텍스트
- `True Mirror + 일반 거울 · 동시에`

## 내레이션
- "남들이 보는 진짜 얼굴과 일반 거울을 한 화면에 동시에 보여줘요."
