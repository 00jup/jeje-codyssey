# S4 · Routine (0:14–0:19, 5s)

> **목표 메시지:** 아침·출근 전·셀카 전 — 매일 10분의 거울 루틴
...
## 모션
- 우상단 `10:00` 타이머 카운트 모션
- 잠금화면 알림 배너 팝업 모션 (리마인더 시각 / "집을 나서기 전 한 번 더") — 짧게 슬라이드 인


## 오버레이 텍스트
- `매일 10분` 강조
- `정해진 시간 리마인더 · 집을 나설 때 알림` (보조 카피)

## 기능 포인트 (루틴 정착 장치)
- **시간 리마인더:** 매일 정해둔 시각(예: 기상 직후·출근 전)에 거울 루틴 알림
- **위치 기반 알림:** 집·지정 장소를 벗어나면 "마지막으로 한 번 확인" 푸시 → 깜빡 잊은 루틴을 외출 직전에 붙잡아 줌
- 둘 다 **선택형 옵션**으로 노출 (강요 아님 → 습관 보조)

## 내레이션
- "아침 화장, 출근 전 점검, 셀카 전 각도까지 — 정해둔 시간에 알려주고 집을 나설 때 한 번 더 챙겨줘요."
